# PR4 — Retrospective development-set selection of the wMSP shrinkage level
...
evaluation datasets — on its pre-widened population. `prereg/W5_lambda_and_nll_prior.md` §2.2 already
