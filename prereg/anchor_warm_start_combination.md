# Pre-registration — make the anchor testable everywhere, and try shrinkage and anchoring together
...
new. Population and controls unchanged from `anchor_at_min_token_probability.md`.
