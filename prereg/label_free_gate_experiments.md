...
> **Recorded outcome:** run. Three gate families, three shuffled controls, three clean nulls, with the per-dataset pattern the opposite of the registered prediction.
