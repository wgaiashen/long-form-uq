# PRE-REGISTRATION — M2: the Qwen2.5-14B replication of the ProbeDriftLong findings
...
- ⚠️ **The training-free floors have been partially observed**: the W6 Lehmer analysis
  (`prereg/W6_lehmer_qwen.md`, `STOCKTAKE_qwen.md` §11) computed and reported per-dataset
...
## 1. The claims (verbatim from `PLAN_execution_post7Aug.md` §3, commit `9731fea`)
...
## 3. Configuration policy (from `PLAN_execution_post7Aug.md` §4, unchanged)
...
baselines (`PLAN_execution_post7Aug.md` §6.6). Coverage is stated per table; a missing cell is
