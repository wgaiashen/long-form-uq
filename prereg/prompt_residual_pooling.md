...
> **Recorded outcome:** run. Complete at 160 of 160 cells with both reproduction gates passing; the method did not clear its gate.
...
Headline status requires the project's standing rule (`prereg/adaptive_lehmer_aggregation.md` §2): the effect
